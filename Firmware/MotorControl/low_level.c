...
Motor_t motors[] = {
    {
        ...
        .pole_pairs = 6, // This value is correct for N5065 motors and Turnigy SK3 series.
        .pos_setpoint = 0.0f,
        ...
        .encoder = {
            ...
            .encoder_cpr = (1024 * 4 * 3), // Default resolution of CUI-AMT102 encoder,
            .encoder_offset = 0,
            .encoder_state = 0,
            .motor_dir = 1,   // 1 or -1
    ...
    {                                             // M1
        ...
        .vel_setpoint = 0.0f,
        .vel_gain = 5.0f / 10000.0f,             // [A/(counts/s)]
        .vel_integrator_gain = 00.0f / 10000.0f,  // [A/(counts/s * s)]
        .vel_integrator_current = 0.0f,           // [A]
        .vel_limit = 20000.0f,                    // [counts/s]
        .current_setpoint = 0.0f,                 // [A]
        .calibration_current = 25.0f,             // [A]
